...
- **ProcessAdapter**: A clean abstraction for spawning processes, streaming output, and sending input.
...
- **Direct Process Management**: Agents are spawned and managed directly by the Node.js orchestrator with per-agent working directories.
