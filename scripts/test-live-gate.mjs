...
async function run() {
  console.log('Starting live MCP exec-RPC consensus smoke test...');
  ...
  if (workCompleted) {
    console.log('TEST PASSED: MCP-exec Consensus E2E reached submit_plan and worker completed task');
    process.exit(0);
  } else {
