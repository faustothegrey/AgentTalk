...
**Task under test:** T1 of `design/bl084-plan.md`. **Predecessor:** rung 5 = [[BL-047]] (`design/rung5-plan.md`).
...
> *"design/bl084-plan.md describes work in three phases; do T1. Verify it, commit on your branch when done. Do
> not push."*
