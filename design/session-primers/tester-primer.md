...
- TL-006 / BL-038 / LB-92: real agy/Gemini is **parked as unfit for MCP attach-client use** for now. The attach
...
- TL-007: real OpenRouter API agents are validated for coordination-layer Continue/Stop testing. Use API-created
  agents with `providerName: openrouter`; they are fast and avoid MCP attach fragility. Residual: BL-040 — API agents
