...
| T2 | Generalise the graded loop at the validation site (correct → retry N=2 → eject, not dual-kill) | Not started. **Rewrites tested dual-kill contracts → needs explicit approval before touching those tests.** |
