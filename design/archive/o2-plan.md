...
`design/archive/o0-operator-launch-plan.md`).
...
> question — and write a design document at `design/archive/bl088-investigation.md` weighing its three recorded options
...
| 4 | The deliverable exists | `design/archive/bl088-investigation.md` present in that commit, weighing **all three** options and stating **one** recommendation | read the file |
