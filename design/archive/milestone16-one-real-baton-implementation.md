...
> **Plan:** `design/archive/milestone16-one-real-baton-plan.md`
...
1. Plan Reviewer approves or refutes `design/archive/milestone16-one-real-baton-plan.md`.
...
`design/archive/m16-t2-bug-report.md`. Awaiting Plan Reviewer approval before implementation.
...
`design/archive/m16-t2-bug-report.md`, the planner spec'd a scoped unblocker. The behavior change is sanctioned through
exactly this gate.
...
```
 ...
 design/archive/milestone16-one-real-baton-implementation.md|  30 +-
