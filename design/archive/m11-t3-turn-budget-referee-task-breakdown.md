...
> **Milestone source:** `design/archive/milestone11-consensus-robustness-plan.md` section M11-T3.
...
- Live observation or explicit deferral is recorded in `design/archive/milestone11-consensus-robustness-implementation.md`.
