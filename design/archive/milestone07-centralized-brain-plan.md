...
**Related:** `design/archive/phase6-multi-agent-consensus-plan.md` (M06) · `CLAUDE.md` (M05) ·
`design/archive/phase5-client-extraction-proposal.md` · `design/collaboration-workflow.md`
