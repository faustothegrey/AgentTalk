...
**Plan:** `design/archive/milestone18-self-hosting-plan.md`
...
@scope:
  allowed:
    - design/archive/milestone18-self-hosting-implementation.md
...
- files the tool sees (`origin/master...HEAD` + porcelain): **8** — the extra three (`design/backlog.md`,
  `design/archive/milestone18-self-hosting-plan.md`, `design/self-hosting-program-draft.md`) are master-side
...
2. Slim the T1 manifest's `allowed` back to what the task touches: remove `design/backlog.md`,
   `design/archive/milestone18-self-hosting-plan.md`, `design/self-hosting-program-draft.md` (with the correct
...
- `node scripts/scope-check.mjs` -> exit 0. With the corrected local-`master` base, the checker saw **5** changed
  files: `design/lessons/gemini-lessons.md`, `design/archive/milestone18-self-hosting-implementation.md`,
...
- Diff-base probe: `git diff --name-only master...HEAD` -> **5 files**; `git diff --name-only origin/master...HEAD`
  still shows the stale **8-file** view including `design/backlog.md`, `design/archive/milestone18-self-hosting-plan.md`,
...
- Planning-doc allowlist probe -> exit 0. `design/backlog.md`, `design/archive/milestone18-self-hosting-plan.md`, and
