...
> (design: `design/archive/bl024-provider-split-design.md`, PO gate passed 2026-07-18; **T2 frozen-engine edit explicitly
...
`design/archive/bl024-t2-plan.md` + backlog/ledger (docs, on master).
