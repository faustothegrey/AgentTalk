...
**Prior evidence:** `design/archive/spike2-consensus-real-cli-implementation.md` closed ATTACH-BLOCKED on 2026-07-11.
...
- This plan, `design/archive/milestone19-real-cli-relay-implementation.md`, evidence under `design/evidence/**`, and
