...
**Plan:** `design/archive/milestone19-real-cli-relay-plan.md`
...
@scope:
  allowed:
    - design/archive/milestone19-real-cli-relay-plan.md
    - design/archive/milestone19-real-cli-relay-implementation.md
    - design/evidence/**
    - packages/contracts/**
