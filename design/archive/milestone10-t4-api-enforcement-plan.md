...
> in `design/archive/milestone10-implementation.md` (§T4); see also **LB-25**.
> Parent: `design/archive/milestone10-phase2-plan.md` (T4 stub, §T4). Decisions D1/D2/D3 already
