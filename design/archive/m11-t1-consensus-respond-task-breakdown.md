...
> **Milestone source:** `design/archive/milestone11-consensus-robustness-plan.md` section M11-T1.
...
Before claiming implementation done, update `design/archive/milestone11-consensus-robustness-implementation.md` with:
