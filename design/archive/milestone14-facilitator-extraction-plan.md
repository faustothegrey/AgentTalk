...
(`design/archive/milestone15-arbiter-consensus-plan.md`, direct-path arbiter consensus).** History in the ledger:
`design/archive/milestone14-facilitator-extraction-implementation.md`.
