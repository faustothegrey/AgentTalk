...
**Related:** `design/archive/milestone07-centralized-brain-plan.md` (M07, closed) · `design/backlog.md` (failure-modes split + M08 gate) ·
`design/collaboration-workflow.md` (method) · `design/logbook.md` (LB-5, LB-9) ·
`design/archive/milestone07-centralized-brain-implementation.md` (IMP-T3b-1, D4, T3b-2 known-limitation note).
