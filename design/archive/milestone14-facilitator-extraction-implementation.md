...
> `design/archive/milestone15-arbiter-consensus-plan.md`): preserving Mode B byte-identically while extracting was
...
> **Plan:** `design/archive/milestone14-facilitator-extraction-plan.md`
