...
**Parent:** `design/archive/milestone10-t4-api-enforcement-plan.md` + backlog item "M10-T4 live-verification probe".
...
- `design/logbook.md` or `design/archive/milestone10-implementation.md`, only to record actual probe results if live checks
  are run
