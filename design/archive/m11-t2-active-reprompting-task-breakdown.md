...
> **Milestone source:** `design/archive/milestone11-consensus-robustness-plan.md` section M11-T2.
...
- Update `design/archive/milestone11-consensus-robustness-implementation.md` with implementer claims, exact commands, and telemetry.
