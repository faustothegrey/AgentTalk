...
| BL-092's option B is a Rule-2 show-stopper | prose, in `design/archive/bl092-investigation.md` |
...
| **BL-084** | `human-only` | `[]` | T2 carries a real behaviour change to fence (`design/archive/bl078-decision.md` §5c). Not for unattended handing. |
