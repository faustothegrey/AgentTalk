...
**Parent:** `design/bl124-plan.md` (S3, §5) · `design/bl124-s2-deploy.md` §7.
...
`design/bl124-plan.md` §2 posed the fork. The answer is **W2**, and more completely than W2 was
stated:
...
**And this retires the 41-boot puzzle.** `design/bl124-plan.md` §1 recorded zero `"has not replied"`
...
`design/bl124-plan.md` §5 anticipated exactly this and called it correctly:
